...
Agora vamos criar uma pasta 'frontend' que é onde vamos trabalhar nossa aplicação front-end.
...
```html
<!-- Criar estrutura html5 básica, uma div '#app' e uma tag script com o 'bundle.js'-->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
